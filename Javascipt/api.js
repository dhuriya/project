...
const btnclick = document.querySelector('#rendombutn');
...
const dogIme = document.querySelector('#dogimg');
dogbtn.addEventListener('click', () => {
    ...
    xhr.addEventListener('load', () => {
        ...
        dogIme.src = xhr.response.message;
    })
    xhr.open('GET','https://dog.ceo/api/breeds/image/random');//https://dog.ceo/api/breeds/image/random
    xhr.send();
})
